...
if ( ! function_exists( 'sargiasrilanka_theme_slug_sanitize_select' ) ) {
	/**
	 * Sanitize select.
	 *
	 * @deprecated 1.2.0 Use sargiasrilanka_customize_sanitize_select()
	 * @see sargiasrilanka_customize_sanitize_select()
	 *
	 * @since 0.6.11
	 *
	 ...
	 */
	function sargiasrilanka_theme_slug_sanitize_select( $input, $setting ) {
		_deprecated_function( __FUNCTION__, '1.2.0', 'sargiasrilanka_customize_sanitize_select' );
		return sargiasrilanka_customize_sanitize_select( $input, $setting );
	}
}
...
if ( ! function_exists( 'sargiasrilanka_adjust_body_class' ) ) {
	 ...
	 */
	function sargiasrilanka_adjust_body_class( $classes ) {
		_deprecated_function( 'sargiasrilanka_adjust_body_class', '0.9.4' );
		return $classes;
	}
}

if ( ! function_exists( 'sargiasrilanka_slbd_count_widgets' ) ) {
	/**
	 ...
	 * @deprecated 0.8.9
	 */
	function sargiasrilanka_slbd_count_widgets( $sidebar_id ) {

		_deprecated_function( 'sargiasrilanka_slbd_count_widgets', '0.8.9', 'sargiasrilanka_widget_classes' );
