...
add_action( 'after_setup_theme', 'sargiasrilanka_block_editor_setup' );

if ( ! function_exists( 'sargiasrilanka_block_editor_setup' ) ) {
	 ...
	 * @since 1.0.0
	 */
	function sargiasrilanka_block_editor_setup() {
		...
		$color_palette = sargiasrilanka_generate_color_palette();
		if ( $color_palette ) {
...
if ( ! function_exists( 'sargiasrilanka_generate_color_palette' ) ) {
	/**
	 ...
	 * @return array
	 */
	function sargiasrilanka_generate_color_palette() {
		$color_palette = array();
		 ...
		 */
		return apply_filters( 'sargiasrilanka_theme_editor_color_palette', $color_palette );
	}
}
